%==============================================
% WorldTheory.pl for actor temperature
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qatutemperature).	%%old version (deprecated)
actorobj(qatutemperature).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor temperature
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of temperature" ). 
...
%-------------------------------------------------
%  User static rules about temperature
%------------------------------------------------- 
/*
------------------------------------------------------------------------
